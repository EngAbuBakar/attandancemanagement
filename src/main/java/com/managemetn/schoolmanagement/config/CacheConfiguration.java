package com.managemetn.schoolmanagement.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.managemetn.schoolmanagement.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            ...
            createCache(cm, com.managemetn.schoolmanagement.domain.Library.class.getName());
