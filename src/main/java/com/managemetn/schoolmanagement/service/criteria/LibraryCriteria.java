...
/**
 * Criteria class for the {@link com.managemetn.schoolmanagement.domain.Library} entity. This class is used
 * in {@link com.managemetn.schoolmanagement.web.rest.LibraryResource} to receive all the possible filtering options from
...
public class LibraryCriteria implements Serializable, Criteria {
    ...
    public LibraryCriteria(LibraryCriteria other) {
        ...
        this.code = other.optionalCode().map(LongFilter::copy).orElse(null);
        this.block = other.optionalBlock().map(StringFilter::copy).orElse(null);
        this.isVisible = other.optionalIsVisible().map(BooleanFilter::copy).orElse(null);
    ...
    public Optional<LongFilter> optionalCode() {
        return Optional.ofNullable(code);
    }

    public LongFilter code() {
        if (code == null) {
            setCode(new LongFilter());
        }
        return code;
    }
    ...
    public Optional<StringFilter> optionalBlock() {
        return Optional.ofNullable(block);
    }

    public StringFilter block() {
        if (block == null) {
            setBlock(new StringFilter());
        }
        return block;
    }
    ...
    public Optional<BooleanFilter> optionalIsVisible() {
        return Optional.ofNullable(isVisible);
    }

    public BooleanFilter isVisible() {
        if (isVisible == null) {
            setIsVisible(new BooleanFilter());
        }
        return isVisible;
    }
    ...
    public String toString() {
        return "LibraryCriteria{" +
            ...
            optionalBlock().map(f -> "block=" + f + ", ").orElse("") +
            optionalIsVisible().map(f -> "isVisible=" + f + ", ").orElse("") +
