...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="schoolManagementApp.department.delete.question">
        <Translate contentKey="schoolManagementApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
