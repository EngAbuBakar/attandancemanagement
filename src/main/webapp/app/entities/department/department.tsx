  ...
  return (
    <div>
      <h2 id="department-heading" data-cy="DepartmentHeading">
        <Translate contentKey="schoolManagementApp.department.home.title">Departments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="schoolManagementApp.department.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/department/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="schoolManagementApp.department.home.createLabel">Create new Department</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departmentList && departmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="schoolManagementApp.department.id">ID</Translate>{' '}
            ...
            <tbody>
              {departmentList.map((department, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {department.createdDate ? <TextFormat type="date" value={department.createdDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {department.lastModifiedDate ? (
                      <TextFormat type="date" value={department.lastModifiedDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="schoolManagementApp.department.home.notFound">No Departments found</Translate>
            </div>
          )
        )}
      </div>
