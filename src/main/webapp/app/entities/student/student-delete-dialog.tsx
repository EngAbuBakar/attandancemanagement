...
export const StudentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="schoolManagementApp.student.delete.question">
        <Translate contentKey="schoolManagementApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
